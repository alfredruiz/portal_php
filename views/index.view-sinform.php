...
<!--             <div class="row">
                ...
                <form name="frmContacto" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                       ...
                       <div class="row">
                                <div class="col-xs-12">
                                    <div class="divbutton">
                                         <button name="btn_send" type="submit" class="btn btn-success btn-lg" onclick="">Enviar</button>
                                    </div>
                                </div>
                          </div>
                        <br>
